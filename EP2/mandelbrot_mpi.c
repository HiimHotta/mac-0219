...
void compute_mandelbrot(){
    ...
    int size, rank, chunksize, leftover, n;
    int initialized, finalized, done;
...
//////// Perform work in parallel//////////////////////////////////////
    ...
    chunksize = (image_size / size);
    leftover  = (image_size % size);
    MPI_Status status;
    ...
    int loop_min    = (int)((long)(tid + 0) * (long)(DIM)/(long)NCPUs);
    int loop_max    = (int)((long)(tid + 1) * (long)(DIM)/(long)NCPUs);
